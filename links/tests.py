...
class LinkModelTest(TestCase):
    def setUp(self):
        ...
        self.link = Link.objects.create(user=self.user, title="Test", url="https://example.com", description="desc")
...
class LinkListViewTest(TestCase):
    def setUp(self):
        ...
        self.link = Link.objects.create(user=self.user, title="Test2", url="https://example2.com", description="desc2")
